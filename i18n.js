(function() {
  ...
  var SUPPORTED_LANGS = ['es', 'pt', 'en', 'fr', 'it', 'de', 'sv', 'da', 'ru', 'zh', 'ja'];
  var PREF_KEY = 'epl_lang_pref_v1';
  var LEGACY_THEME_KEY = 'epl_theme_pref_v1';
  var THEME_STATE_KEY = 'epl_theme_state_v2';
  var GEO_KEY = 'epl_geo_cache_v1';
