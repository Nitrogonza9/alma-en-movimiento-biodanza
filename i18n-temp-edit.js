(function() {
  ...
  var BASE_EN = {
    ...
    process: {
      ...
      steps: [
        { title: 'Learn about Biodanza', desc: 'Contact us via WhatsApp, Instagram or email. We tell you all about Biodanza, our workshops and answer all your questions.' },
    ...
    form: {
      title: 'Contact us',
      name: 'Full name', email: 'Email', phone: 'Phone / WhatsApp', checkin: 'Workshop of interest', nights: 'Workshop of interest', unit: 'Workshop of interest', message: 'Message (optional)',
